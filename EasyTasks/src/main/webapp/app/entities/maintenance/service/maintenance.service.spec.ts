...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../maintenance.test-samples';
...
describe('Maintenance Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Maintenance', () => {
      ...
      service.create(maintenance).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Maintenance', () => {
      ...
      service.update(maintenance).subscribe(resp => (expectedResult = resp.body));
