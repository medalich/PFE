...
public class FactureResource {
        ...
        Optional<Facture> result = factureRepository
            ...
            .map(existingFacture -> {
                if (facture.getRefFacture() != null) {
                    existingFacture.setRefFacture(facture.getRefFacture());
                }
                ...
                if (facture.getEtat() != null) {
                    existingFacture.setEtat(facture.getEtat());
                }
    ...
    public ResponseEntity<Facture> getFacture(@PathVariable Long id) {
        ...
        Optional<Facture> facture = factureRepository.findOneWithEagerRelationships(id);
