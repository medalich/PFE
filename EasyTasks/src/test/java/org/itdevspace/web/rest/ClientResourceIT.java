...
import org.itdevspace.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    private static final String DEFAULT_REF_CLIENT = "AAAAAAAAAA";
    private static final String UPDATED_REF_CLIENT = "BBBBBBBBBB";
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().refClient(DEFAULT_REF_CLIENT).nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).contact(DEFAULT_CONTACT);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().refClient(UPDATED_REF_CLIENT).nom(UPDATED_NOM).prenom(UPDATED_PRENOM).contact(UPDATED_CONTACT);
        return client;
    }
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getRefClient()).isEqualTo(DEFAULT_REF_CLIENT);
    ...
    @Test
    @Transactional
    void checkRefClientIsRequired() throws Exception {
        int databaseSizeBeforeTest = clientRepository.findAll().size();
        // set the field null
        client.setRefClient(null);
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].refClient").value(hasItem(DEFAULT_REF_CLIENT)))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.refClient").value(DEFAULT_REF_CLIENT))
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.refClient(UPDATED_REF_CLIENT).nom(UPDATED_NOM).prenom(UPDATED_PRENOM).contact(UPDATED_CONTACT);
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getRefClient()).isEqualTo(UPDATED_REF_CLIENT);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.refClient(UPDATED_REF_CLIENT).nom(UPDATED_NOM).prenom(UPDATED_PRENOM);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.refClient(UPDATED_REF_CLIENT).nom(UPDATED_NOM).prenom(UPDATED_PRENOM).contact(UPDATED_CONTACT);
